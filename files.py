...
The full list of library files is as follows:
    fmsCellInfoTable.txt      -- UPDATED FOR 2015
    large_gaincurve_par.txt   -- currently average alpha's used
    small_gaincurve_par.txt   -- currently average alpha's used
    leCroyMappingTable.txt    -- DEPRECATED ??
...
class Files:
    ...
    def set_paths(self):
        ...
        names = [os.curdir, os.path.realpath('tables'), os.path.expanduser('~/.fms')]
